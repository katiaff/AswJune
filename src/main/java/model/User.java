...
public class User {
	...
	public User(String firstName, String lastName, Date dateOfBirth, String address, String nationality, String email,
			String password, String dni, int pollingStation) {
		super();
	...
	public String toString() {
		return "User [firstName=" + firstName + ", lastName=" + lastName + ", dateOfBirth=" + dateOfBirth + ", address="
				+ address + ", nationality=" + nationality + ", email=" + email + ", password=" + password + ", dni="
				+ dni + ", pollingStation=" + pollingStation + "]";
	}
}
